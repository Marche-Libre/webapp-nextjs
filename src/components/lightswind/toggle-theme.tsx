...
export const ToggleTheme = ({
    ...
    useEffect(() => {
        const updateTheme = () => {
            ...
            setIsDark(theme !== "marchelibre-light")
        }

        // Restore from localStorage
        const saved = localStorage.getItem("theme")
        if (saved === "light") {
            document.documentElement.setAttribute("data-theme", "marchelibre-light")
    ...
    const toggleTheme = useCallback(async () => {
        ...
        await document.startViewTransition(() => {
            flushSync(() => {
                ...
                document.documentElement.setAttribute("data-theme", newTheme ? "marchelibre" : "marchelibre-light")
